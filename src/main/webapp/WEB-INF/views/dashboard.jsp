...
<div class="page-container">
    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
        <h1>MY VEHICLES</h1>
        <a href="vehicle?action=add" class="btn-primary-custom" style="padding: 10px 20px; text-decoration: none; border-radius: 4px; font-weight: bold;">+ ADD VEHICLE</a>
    </div>
    ...
    <div class="card-grid">
        <c:forEach var="v" items="${myVehicles}">
            <div class="card">
                ...
                <div style="font-size: 1.1rem; font-weight: 700; color: var(--primary); margin-bottom: 20px; font-family:'Oswald',sans-serif; letter-spacing: 1px;">
                    ${v.licensePlate}
                </div>
                ...
                <div class="card-stat">
                    ...
                    <span class="val" style="font-size: 0.85rem; max-width: 150px; text-align:right;">${v.specificData}</span>
                </div>
                
                <div class="card-actions">
                    <a href="vehicle?action=delete&id=${v.vehicleId}" class="btn-sm-danger" onclick="return confirm('Delete this vehicle?')">Delete</a>
                </div>
            </div>
        </c:forEach>
    </div>
    ...
    <c:if test="${empty myVehicles}">
        <div class="empty-state">
            <img src="${pageContext.request.contextPath}/images/autocare_hero.png" style="width: 100px; height: 100px; border-radius:50%; object-fit:cover; margin-bottom:20px; border:3px solid var(--border);" />
