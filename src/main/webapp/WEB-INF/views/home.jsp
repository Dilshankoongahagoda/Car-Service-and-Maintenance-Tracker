        ...
        <body>
            ...
            <nav class="navbar-custom">
                <div class="navbar-inner">
                    ...
                    <div class="nav-right">
                        <a href="user" class="btn-primary-custom"
                            style="padding: 10px 20px; margin-right: 10px; background: transparent; color: var(--primary); border: 2px solid var(--primary);">SIGN
                            IN</a>
                        <a href="user?action=register" class="btn-primary-custom"
            ...
            <section class="hero-section">
                <div class="hero-left">
                    ...
                    <a href="user?action=register" class="btn-primary-custom animate-fade-in-up delay-500">GET STARTED &gt;</a>
                </div>
            ...
            <!-- ========== CTA SECTION ========== -->
            <div class="reveal" style="background: var(--dark); padding: 60px 0; text-align: center;">
                <div class="page-container">
                    <h2
                        style="font-family: 'Oswald', sans-serif; font-size: 2.5rem; color: white; margin-bottom: 15px;">
                        Ready to manage your vehicle <span style="color: var(--primary);">smarter?</span></h2>
                    <p
                        style="color: #999; font-size: 1.1rem; margin-bottom: 30px; max-width: 500px; margin-left: auto; margin-right: auto;">
                        Create a free account to track maintenance, book appointments, and keep your vehicle in top
                        condition.</p>
                    <a href="user?action=register" class="btn-primary-custom"
                        style="padding: 15px 40px; font-size: 1.1rem;">CREATE FREE ACCOUNT &gt;</a>
                </div>
            </div>
                        ...
                        <div class="accordion">
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-answer">
                                    <div class="faq-answer-inner" style="padding: 20px 0;">
